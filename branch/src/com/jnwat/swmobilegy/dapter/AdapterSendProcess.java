...
public class AdapterSendProcess extends BaseAdapter{
	...
	public View getView(int position, View Convertview, ViewGroup parent) {
		...
		if(Convertview==null){
			...
			Convertview =LayoutInflater.from(mContext).inflate(R.layout.item_sendprocess_listview, null);
			viewHolder.promoterName = (TextView) Convertview.findViewById(R.id.tv_promoter_name);
			viewHolder.sendProcessTime = (TextView) Convertview.findViewById(R.id.tv_promoter_time);
			viewHolder.sendProcessContent = (TextView) Convertview.findViewById(R.id.tv_sendProcess_description);
			viewHolder.promoterImage    = (ImageView)Convertview.findViewById(R.id.iv_circleImageView_promoter);
		}else{
