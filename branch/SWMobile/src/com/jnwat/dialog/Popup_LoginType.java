...
import com.jnwat.view.ViewHolder;

/**
 * 功能描述：标题按钮上的弹窗（继承自PopupWindow）
 */
public class Popup_LoginType extends PopupWindow {
	...
	public Popup_LoginType(Context context) {
		// 设置布局的参数
		this(context, LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
	}

	@SuppressWarnings("deprecation")
	public Popup_LoginType(Context context, int width, int height) {
	...
	public void show(View view) {
		...
		showAsDropDown(view);
		// showAtLocation(view, popupGravity, mScreenWidth , mRect.left);
	}
