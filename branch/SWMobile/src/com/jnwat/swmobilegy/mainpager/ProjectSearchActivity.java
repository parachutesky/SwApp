...
public class ProjectSearchActivity extends FragmentActivity {
	...
	class myPagerAdapter extends FragmentPagerAdapter {
		AllProjectNotDoFragment fragment1;
		AllProjectStartingFragment fragment2;
		AllProjectEndFragment fragment3;
		...
		public Fragment getItem(int position) {
			...
			case 0:
				if (null == fragment1) {
					fragment1 = new AllProjectNotDoFragment();
				}

				return fragment1;
			case 1:
				if (null == fragment2) {
					fragment2 = new AllProjectStartingFragment();
				}
				return fragment2;
			default:
				if (null == fragment3) {
					fragment3 = new AllProjectEndFragment();
				}
