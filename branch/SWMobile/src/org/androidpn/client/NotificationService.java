...
/*        editor.putString(Constants.XMPP_USERNAME, bundle.getString("username"));
        editor.putString(Constants.XMPP_PASSWORD, bundle.getString("password"));*/
        editor.commit();
