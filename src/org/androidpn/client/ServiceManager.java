...
public final class ServiceManager {
	...
	public ServiceManager(Context context, String username, String imei) {
		...
		editor.putString(Constants.XMPP_PASSWORD, imei);
	...
	public void startService() {
		Thread serviceThread = new Thread(new Runnable() {
			...
			public void run() {
				...
				System.out.println("startService...intent..." + intent);
	...
	public void stopService() {
		...
		System.out.println("停止Service服务");
			}
		});
		serviceThread.start();
	}
	...
	private Properties loadProperties() {
		...
		try {
			int id = context.getResources().getIdentifier("settings", "raw",
