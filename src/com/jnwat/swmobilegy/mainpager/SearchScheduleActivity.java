...
public class SearchScheduleActivity extends BaseActivity {
	...
	private void getSearchSchedule(final int mnub, final boolean isClear) {
		...
		String url = "";
		System.out.println("BIntentObj.isGetClass ---" + BIntentObj.isGetClass);
		if (BIntentObj.isGetClass == 0) {
			...
			LogUtils.d("课程查询A:" + url + "当前页：" + mnub + "id"
					+ BUserlogin.userid);
		} else {// 详情查看
			...
			LogUtils.d("课程查询B:" + url + "当前页：" + mnub + "projectid ... "
					+ projectid);
		}
		...
		public void handleMessage(android.os.Message msg) {
			...
			case 9:
				...
				if (list_size < 1) {
					...
					textView_show.setText("暂时没有您的课程安排！");
				} else {
