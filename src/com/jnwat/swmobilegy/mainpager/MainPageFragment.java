...
public class MainPageFragment extends Fragment {
	...
	private String[] name_teacher = { "通知公告", "办班通知", "培训项目", "工作流程", "非教学工作",
			"培训项目统计", "薪资查询", "我的课表", "我的项目" };
	...
	public void initListen() {
		gridview_sw_main.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				// TODO Auto-generated method stub
				if (name_teacher[position].equals("办班通知")) {
					...
					startActivity(intent);
				} else if (name_teacher[position].equals("我的课表")) {
				...
				} else if (name_teacher[position].equals("工作流程")) {

					intent.setClass(getActivity(), QingJianMan.class);
					startActivity(intent);

					// ToastViewTools.initToast(getActivity(), "功能开发中，尽请期待");

				} else if (name_teacher[position].equals("通知公告")) {
					intent.setClass(getActivity(),
							NotifyAndMessageActivity.class);
					startActivity(intent);
					/*
					 * intent.setClass(getActivity(),
	...
	class MyAdapter extends BaseAdapter {
		// 图片数组
		private Integer[] imgs_teacher = { 
				R.drawable.index_shortcut_icon4,
				R.drawable.index_shortcut_icon8,
