...
public class SelectSideBar extends View {
	private char[] l;
	...
	public SelectSideBar(Context context) {
		super(context);
		init();
	}

	public SelectSideBar(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}
	...
	public SelectSideBar(Context context, AttributeSet attrs, int defStyle) {
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		if (event.getAction() == MotionEvent.ACTION_DOWN
			...
			if (sectionIndexter == null) {
				NotifyContactAdapter ha  = (NotifyContactAdapter) list.getAdapter();
