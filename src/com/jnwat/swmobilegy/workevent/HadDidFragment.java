...
public class HadDidFragment extends Fragment {
	...
	private final String FROM_VALUE = "HadDidFragment";
	...
	public void initListen() {
		...
		list.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View view,
				...
				BIntentObj.IsHadDidProcess = false;
				intent.putExtra("From", FROM_VALUE);
	...
	public void getWebData() {
		...
		String url = AppConfig.getIp(mContext)+AppConfig.METHOAD_GETUSERYIBAN_OA;
	...
	public void onResume() {
		...
		if (BUserlogin.loginStatus == 1 && BIntentObj.IsHadDidProcess == true
				&& view != null && allowFresh == true) {
			System.out.println("已办Onresume");
			clearData();
			getWebData();
		}
