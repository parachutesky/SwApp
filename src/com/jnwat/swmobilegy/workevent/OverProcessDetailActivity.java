...
public class OverProcessDetailActivity extends BaseActivity {
	...
	public void getWebData(final String userNo, final String flowid) {
		...
		String url = AppConfig.getIp(OverProcessDetailActivity.this)
	...
	public Handler mmHandler = new Handler() {
		public void handleMessage(android.os.Message msg) {
			...
			case 0:
				ToastViewTools
						.initToast(OverProcessDetailActivity.this, "暂无数据");
				freshList();
				break;
			case ShowRemind.HANDLER_STATUS:
				ToastViewTools.initToast(OverProcessDetailActivity.this,
