...
import com.jnwat.swmobilegy.mainpager.ChartTrainActivity;
	...
	Handler mHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case 1:
				...
				mPopLoginDialog
						.showPoploginDialog(TrainingProgramActivity.this);
				break;
			...
			case 100:
				adapter = new TrainingProgramListAdapter(
						TrainingProgramActivity.this, list);
	...
	protected void setView() {
		...
		mProgram_lv.setOnItemClickListener(new OnItemClickListener() {
			...
			if(arg2>2){
				...
				intent.setClass(TrainingProgramActivity.this,
						ChartTrainActivity.class);
				...
				new RequestCallBack<String>() {
					...
					public void onSuccess(ResponseInfo<String> responseInfo) {
						...
						try {
							...
							list = mUnEduMessage
									.getTrainingList(responseInfo.result);
