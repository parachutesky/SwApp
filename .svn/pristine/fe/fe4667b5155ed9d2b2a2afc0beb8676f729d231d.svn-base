...
public class NoticeSortMessageActivity extends BaseActivity {
	private TextView tv_notice_title, tv_notice_content, tv_notice_time,title_bar_name;
	...
	protected void setView() {
		...
		try {
			...
			iskkaike = intent.getBooleanExtra("iskkaike",false);
