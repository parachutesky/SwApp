...
package com.jnwat.swmobilegy.view;
...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	// @formatter:off
	private static final int[] ATTRS = new int[] { R.styleable.MyView_textSize,
	...
	private int indicatorColor = 0xFF04A3FF;
	...
	private int tabTextColor = R.drawable.selector_tabtext;
