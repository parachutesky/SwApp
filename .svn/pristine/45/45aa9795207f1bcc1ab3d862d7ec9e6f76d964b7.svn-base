	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			case 1:
				...
				mviewHolder.textView_sw_item_schedul_teacher = (TextView) convertView
						.findViewById(R.id.textView_sw_item_schedul_teacher);
		...
		case 0:
			...
			break;
		case 1:
			if (BIntentObj.isGetClass == 1) {
				mviewHolder.textView_sw_item_schedul_course.setText(data.get(
						position).get("COURSE"));
				mviewHolder.textView_sw_item_schedul_teacher
						.setVisibility(View.VISIBLE);
				String teacher = data.get(position).get("Teacher");
				if (teacher.trim().equals("")) {
					teacher = "";
				} else {
					mviewHolder.textView_sw_item_schedul_teacher.setText(data
							.get(position).get("Teacher"));
				}
...
class viewHolder {
	...
	public TextView textView_sw_item_schedul_teacher;
